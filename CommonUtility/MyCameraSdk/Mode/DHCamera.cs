using CommonUtility.MyCameraSdk.Cameralibs.DHCmera;
...
namespace CommonUtility.MyCameraSdk.Mode
{
    internal class DHCamera : BaseCamera
    {
        ...
        /// 白平衡列表框转换标志
        /// </summary>
        bool m_bWhiteAutoSelectedIndex = true;
        ...
        /// 自动白平衡当前的值
        /// </summary>
        string m_strBalanceWhiteAutoValue = "Off";

        /// <summary>
        /// 颜色校正使能标志位
        /// </summary>
        bool m_bEnableColorCorrect = false;

        /// <summary>
        /// Gamma使能标志位
        /// </summary>
        bool m_bEnableGamma = false;

        /// <summary>
        /// 锐化使能标志位
        /// </summary>
        bool m_bEnableSharpness = false;

        /// <summary>
        /// 自动白平衡使能标志位
        /// </summary>
        bool m_bEnableAutoWhite = false;

        /// <summary>
        /// 自动白平衡光源使能标志位
        /// </summary>
        bool m_bEnableAwbLight = false;
        ...
        /// 饱和度使能标志位
        /// </summary>
        bool m_bEnableSaturation = false;

        /// <summary>
        /// 是否枚举到设备标志位
        /// </summary>
        bool m_bEnumDevices = false;

        /// <summary>
        /// 存放枚举到的设备的容器
        /// </summary>
        List<IGXDeviceInfo> m_listGXDeviceInfo;
