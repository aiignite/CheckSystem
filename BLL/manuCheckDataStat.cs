...
namespace BLL
{
	...
	{
		private readonly DAL.manuCheckDataStat dal=new DAL.manuCheckDataStat();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.manuCheckDataStat GetModelByCache(int id)
		{
			
			string CacheKey = "manuCheckDataStatModel-" + id;
			...
			return (Model.manuCheckDataStat)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manuCheckDataStat> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manuCheckDataStat> DataTableToList(DataTable dt)
		{
			List<Model.manuCheckDataStat> modelList = new List<Model.manuCheckDataStat>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.manuCheckDataStat model;
