...
{
	/// <summary>
	/// manufactureBasicData
	/// </summary>
	public partial class manufactureBasicData
	{
		private readonly DAL.manufactureBasicData dal=new DAL.manufactureBasicData();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.manufactureBasicData GetModelByCache(int id)
		{
			
			string CacheKey = "manufactureBasicDataModel-" + id;
			...
			return (Model.manufactureBasicData)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manufactureBasicData> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manufactureBasicData> DataTableToList(DataTable dt)
		{
			List<Model.manufactureBasicData> modelList = new List<Model.manufactureBasicData>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.manufactureBasicData model;
