...
namespace BLL
{
	...
	{
		private readonly DAL.agvRfidInfo dal=new DAL.agvRfidInfo();
		public agvRfidInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.agvRfidInfo GetModelByCache(int id)
		{
			
			string CacheKey = "agvRfidInfoModel-" + id;
			...
			return (Model.agvRfidInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.agvRfidInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.agvRfidInfo> DataTableToList(DataTable dt)
		{
			List<Model.agvRfidInfo> modelList = new List<Model.agvRfidInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.agvRfidInfo model;
