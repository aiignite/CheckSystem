...
namespace BLL
{
	...
	{
		private readonly DAL.wmsMaterialStockInDetail dal=new DAL.wmsMaterialStockInDetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.wmsMaterialStockInDetail GetModelByCache(int id)
		{
			
			string CacheKey = "wmsMaterialStockInDetailModel-" + id;
			...
			return (Model.wmsMaterialStockInDetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsMaterialStockInDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsMaterialStockInDetail> DataTableToList(DataTable dt)
		{
			List<Model.wmsMaterialStockInDetail> modelList = new List<Model.wmsMaterialStockInDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.wmsMaterialStockInDetail model;
