...
namespace BLL
{
	...
	{
		private readonly DAL.agvInfo dal=new DAL.agvInfo();
		public agvInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.agvInfo GetModelByCache(int id)
		{
			
			string CacheKey = "agvInfoModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.agvInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.agvInfo> DataTableToList(DataTable dt)
		{
			List<Model.agvInfo> modelList = new List<Model.agvInfo>();
