...
namespace BLL
{
	...
	{
		private readonly DAL.pdPFD dal=new DAL.pdPFD();
		public pdPFD()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.pdPFD GetModelByCache(int id)
		{
			
			string CacheKey = "pdPFDModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdPFD> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdPFD> DataTableToList(DataTable dt)
		{
			List<Model.pdPFD> modelList = new List<Model.pdPFD>();
