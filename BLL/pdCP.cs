...
namespace BLL
{
	...
	{
		private readonly DAL.pdCP dal=new DAL.pdCP();
		public pdCP()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.pdCP GetModelByCache(int id)
		{
			
			string CacheKey = "pdCPModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdCP> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdCP> DataTableToList(DataTable dt)
		{
			List<Model.pdCP> modelList = new List<Model.pdCP>();
