...
namespace BLL
{
	...
	{
		private readonly DAL.ledFile dal=new DAL.ledFile();
		public ledFile()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.ledFile GetModelByCache(int id)
		{
			
			string CacheKey = "ledFileModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ledFile> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ledFile> DataTableToList(DataTable dt)
		{
			List<Model.ledFile> modelList = new List<Model.ledFile>();
