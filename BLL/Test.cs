...
namespace BLL
{
	...
	{
		private readonly DAL.Test dal=new DAL.Test();
		public Test()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.Test GetModelByCache(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.Test> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.Test> DataTableToList(DataTable dt)
		{
			List<Model.Test> modelList = new List<Model.Test>();
