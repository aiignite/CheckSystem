...
namespace BLL
{
	...
	{
		private readonly DAL.commDocumentsInfo dal=new DAL.commDocumentsInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.commDocumentsInfo GetModelByCache(int id)
		{
			
			string CacheKey = "commDocumentsInfoModel-" + id;
			...
			return (Model.commDocumentsInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.commDocumentsInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.commDocumentsInfo> DataTableToList(DataTable dt)
		{
			List<Model.commDocumentsInfo> modelList = new List<Model.commDocumentsInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.commDocumentsInfo model;
