...
namespace BLL
{
	...
	{
		private readonly DAL.pdPFMEADetail dal=new DAL.pdPFMEADetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.pdPFMEADetail GetModelByCache(int id)
		{
			
			string CacheKey = "pdPFMEADetailModel-" + id;
			...
			return (Model.pdPFMEADetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdPFMEADetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdPFMEADetail> DataTableToList(DataTable dt)
		{
			List<Model.pdPFMEADetail> modelList = new List<Model.pdPFMEADetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.pdPFMEADetail model;
