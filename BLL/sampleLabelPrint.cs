...
namespace BLL
{
	...
	{
		private readonly DAL.sampleLabelPrint dal=new DAL.sampleLabelPrint();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.sampleLabelPrint GetModelByCache(int id)
		{
			
			string CacheKey = "sampleLabelPrintModel-" + id;
			...
			return (Model.sampleLabelPrint)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.sampleLabelPrint> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.sampleLabelPrint> DataTableToList(DataTable dt)
		{
			List<Model.sampleLabelPrint> modelList = new List<Model.sampleLabelPrint>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.sampleLabelPrint model;
