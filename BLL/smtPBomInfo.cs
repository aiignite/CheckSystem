...
namespace BLL
{
	...
	{
		private readonly DAL.smtPBomInfo dal=new DAL.smtPBomInfo();
		public smtPBomInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.smtPBomInfo GetModelByCache(int id)
		{
			
			string CacheKey = "smtPBomInfoModel-" + id;
			...
			return (Model.smtPBomInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtPBomInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtPBomInfo> DataTableToList(DataTable dt)
		{
			List<Model.smtPBomInfo> modelList = new List<Model.smtPBomInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.smtPBomInfo model;
