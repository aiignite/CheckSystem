...
namespace BLL
{
	...
	{
		private readonly DAL.salaryResult dal=new DAL.salaryResult();
		public salaryResult()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.salaryResult GetModelByCache(int id)
		{
			
			string CacheKey = "salaryResultModel-" + id;
			...
			return (Model.salaryResult)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.salaryResult> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.salaryResult> DataTableToList(DataTable dt)
		{
			List<Model.salaryResult> modelList = new List<Model.salaryResult>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.salaryResult model;
