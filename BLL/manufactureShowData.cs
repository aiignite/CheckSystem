...
namespace BLL
{
	...
	{
		private readonly DAL.manufactureShowData dal=new DAL.manufactureShowData();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.manufactureShowData GetModelByCache(int id)
		{
			
			string CacheKey = "manufactureShowDataModel-" + id;
			...
			return (Model.manufactureShowData)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manufactureShowData> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manufactureShowData> DataTableToList(DataTable dt)
		{
			List<Model.manufactureShowData> modelList = new List<Model.manufactureShowData>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.manufactureShowData model;
