...
namespace BLL
{
	...
	{
		private readonly DAL.qaProductSmsInfo dal=new DAL.qaProductSmsInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.qaProductSmsInfo GetModelByCache(int id)
		{
			
			string CacheKey = "qaProductSmsInfoModel-" + id;
			...
			return (Model.qaProductSmsInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.qaProductSmsInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.qaProductSmsInfo> DataTableToList(DataTable dt)
		{
			List<Model.qaProductSmsInfo> modelList = new List<Model.qaProductSmsInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.qaProductSmsInfo model;
