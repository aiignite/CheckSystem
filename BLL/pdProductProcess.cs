...
namespace BLL
{
	...
	{
		private readonly DAL.pdProductProcess dal=new DAL.pdProductProcess();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.pdProductProcess GetModelByCache(int id)
		{
			
			string CacheKey = "pdProductProcessModel-" + id;
			...
			return (Model.pdProductProcess)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdProductProcess> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdProductProcess> DataTableToList(DataTable dt)
		{
			List<Model.pdProductProcess> modelList = new List<Model.pdProductProcess>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.pdProductProcess model;
