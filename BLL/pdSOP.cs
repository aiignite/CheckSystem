...
namespace BLL
{
	...
	{
		private readonly DAL.pdSOP dal=new DAL.pdSOP();
		public pdSOP()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.pdSOP GetModelByCache(int id)
		{
			
			string CacheKey = "pdSOPModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdSOP> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.pdSOP> DataTableToList(DataTable dt)
		{
			List<Model.pdSOP> modelList = new List<Model.pdSOP>();
