...
namespace BLL
{
	...
	{
		private readonly DAL.smtBomInfo dal=new DAL.smtBomInfo();
		public smtBomInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.smtBomInfo GetModelByCache(int id)
		{
			
			string CacheKey = "smtBomInfoModel-" + id;
			...
			return (Model.smtBomInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtBomInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtBomInfo> DataTableToList(DataTable dt)
		{
			List<Model.smtBomInfo> modelList = new List<Model.smtBomInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.smtBomInfo model;
