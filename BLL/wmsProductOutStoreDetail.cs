...
namespace BLL
{
	...
	{
		private readonly DAL.wmsProductOutStoreDetail dal=new DAL.wmsProductOutStoreDetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.wmsProductOutStoreDetail GetModelByCache(int id)
		{
			
			string CacheKey = "wmsProductOutStoreDetailModel-" + id;
			...
			return (Model.wmsProductOutStoreDetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsProductOutStoreDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsProductOutStoreDetail> DataTableToList(DataTable dt)
		{
			List<Model.wmsProductOutStoreDetail> modelList = new List<Model.wmsProductOutStoreDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.wmsProductOutStoreDetail model;
