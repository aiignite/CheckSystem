...
namespace BLL
{
	...
	public partial class ExamPaper
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.ExamPaper GetModelByCache(string id)
		{
			
			string CacheKey = "ExamPaperModel-" + id;
			...
			return (Model.ExamPaper)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ExamPaper> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ExamPaper> DataTableToList(DataTable dt)
		{
			List<Model.ExamPaper> modelList = new List<Model.ExamPaper>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.ExamPaper model;
