...
namespace BLL
{
	...
	{
		private readonly DAL.productQualityInfo dal=new DAL.productQualityInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.productQualityInfo GetModelByCache(int id)
		{
			
			string CacheKey = "productQualityInfoModel-" + id;
			...
			return (Model.productQualityInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.productQualityInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.productQualityInfo> DataTableToList(DataTable dt)
		{
			List<Model.productQualityInfo> modelList = new List<Model.productQualityInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.productQualityInfo model;
