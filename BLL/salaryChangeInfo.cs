...
namespace BLL
{
	...
	{
		private readonly DAL.salaryChangeInfo dal=new DAL.salaryChangeInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.salaryChangeInfo GetModelByCache(int id)
		{
			
			string CacheKey = "salaryChangeInfoModel-" + id;
			...
			return (Model.salaryChangeInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.salaryChangeInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.salaryChangeInfo> DataTableToList(DataTable dt)
		{
			List<Model.salaryChangeInfo> modelList = new List<Model.salaryChangeInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.salaryChangeInfo model;
