...
namespace BLL
{
	...
	{
		private readonly DAL.deviceRepairData dal=new DAL.deviceRepairData();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.deviceRepairData GetModelByCache(int id)
		{
			
			string CacheKey = "deviceRepairDataModel-" + id;
			...
			return (Model.deviceRepairData)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.deviceRepairData> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.deviceRepairData> DataTableToList(DataTable dt)
		{
			List<Model.deviceRepairData> modelList = new List<Model.deviceRepairData>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.deviceRepairData model;
