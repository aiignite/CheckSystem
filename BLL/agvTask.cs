...
namespace BLL
{
	...
	{
		private readonly DAL.agvTask dal=new DAL.agvTask();
		public agvTask()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.agvTask GetModelByCache(int id)
		{
			
			string CacheKey = "agvTaskModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.agvTask> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.agvTask> DataTableToList(DataTable dt)
		{
			List<Model.agvTask> modelList = new List<Model.agvTask>();
