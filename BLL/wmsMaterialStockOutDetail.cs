...
namespace BLL
{
	...
	{
		private readonly DAL.wmsMaterialStockOutDetail dal=new DAL.wmsMaterialStockOutDetail();
		...
		{
			return dal.Exists(stockOutNo,id);
		}
		...
		public bool Delete(string stockOutNo,int id)
		{
			...
			return dal.Delete(stockOutNo,id);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.wmsMaterialStockOutDetail GetModelByCache(int id)
		{
			
			string CacheKey = "wmsMaterialStockOutDetailModel-" + id;
			...
			return (Model.wmsMaterialStockOutDetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsMaterialStockOutDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsMaterialStockOutDetail> DataTableToList(DataTable dt)
		{
			List<Model.wmsMaterialStockOutDetail> modelList = new List<Model.wmsMaterialStockOutDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.wmsMaterialStockOutDetail model;
