...
{
	/// <summary>
	/// smtSolderPasteDetail
	/// </summary>
	public partial class smtSolderPasteDetail
	{
		private readonly DAL.smtSolderPasteDetail dal=new DAL.smtSolderPasteDetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.smtSolderPasteDetail GetModelByCache(int id)
		{
			
			string CacheKey = "smtSolderPasteDetailModel-" + id;
			...
			return (Model.smtSolderPasteDetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtSolderPasteDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtSolderPasteDetail> DataTableToList(DataTable dt)
		{
			List<Model.smtSolderPasteDetail> modelList = new List<Model.smtSolderPasteDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.smtSolderPasteDetail model;
