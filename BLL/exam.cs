...
namespace BLL
{
	...
	public partial class exam
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.exam GetModelByCache(int id)
		{
			
			string CacheKey = "examModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.exam> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.exam> DataTableToList(DataTable dt)
		{
			List<Model.exam> modelList = new List<Model.exam>();
