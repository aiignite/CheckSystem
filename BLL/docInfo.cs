...
namespace BLL
{
	...
	{
		private readonly DAL.docInfo dal=new DAL.docInfo();
		public docInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.docInfo GetModelByCache(int id)
		{
			
			string CacheKey = "docInfoModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.docInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.docInfo> DataTableToList(DataTable dt)
		{
			List<Model.docInfo> modelList = new List<Model.docInfo>();
