...
namespace BLL
{
	...
	{
		private readonly DAL.deviceInfo dal=new DAL.deviceInfo();
		public deviceInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.deviceInfo GetModelByCache(int id)
		{
			
			string CacheKey = "deviceInfoModel-" + id;
			...
			return (Model.deviceInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.deviceInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.deviceInfo> DataTableToList(DataTable dt)
		{
			List<Model.deviceInfo> modelList = new List<Model.deviceInfo>();
