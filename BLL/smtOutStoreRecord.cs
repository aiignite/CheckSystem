...
namespace BLL
{
	...
	{
		private readonly DAL.smtOutStoreRecord dal=new DAL.smtOutStoreRecord();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.smtOutStoreRecord GetModelByCache(int id)
		{
			
			string CacheKey = "smtOutStoreRecordModel-" + id;
			...
			return (Model.smtOutStoreRecord)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtOutStoreRecord> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smtOutStoreRecord> DataTableToList(DataTable dt)
		{
			List<Model.smtOutStoreRecord> modelList = new List<Model.smtOutStoreRecord>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.smtOutStoreRecord model;
