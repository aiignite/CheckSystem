...
{
	/// <summary>
	/// manufactureCheckTemp
	/// </summary>
	public partial class manufactureCheckTemp
	{
		private readonly DAL.manufactureCheckTemp dal=new DAL.manufactureCheckTemp();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.manufactureCheckTemp GetModelByCache(int id)
		{
			
			string CacheKey = "manufactureCheckTempModel-" + id;
			...
			return (Model.manufactureCheckTemp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manufactureCheckTemp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.manufactureCheckTemp> DataTableToList(DataTable dt)
		{
			List<Model.manufactureCheckTemp> modelList = new List<Model.manufactureCheckTemp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.manufactureCheckTemp model;
