...
namespace BLL
{
	...
	{
		private readonly DAL.smsStrategyInfo dal=new DAL.smsStrategyInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.smsStrategyInfo GetModelByCache(int id)
		{
			
			string CacheKey = "smsStrategyInfoModel-" + id;
			...
			return (Model.smsStrategyInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smsStrategyInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.smsStrategyInfo> DataTableToList(DataTable dt)
		{
			List<Model.smsStrategyInfo> modelList = new List<Model.smsStrategyInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.smsStrategyInfo model;
