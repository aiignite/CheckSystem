...
namespace BLL
{
	...
	{
		private readonly DAL.ledBase dal=new DAL.ledBase();
		public ledBase()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.ledBase GetModelByCache(int id)
		{
			
			string CacheKey = "ledBaseModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ledBase> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ledBase> DataTableToList(DataTable dt)
		{
			List<Model.ledBase> modelList = new List<Model.ledBase>();
