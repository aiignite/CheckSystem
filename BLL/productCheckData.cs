...
namespace BLL
{
	...
	{
		private readonly DAL.productCheckData dal=new DAL.productCheckData();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.productCheckData GetModelByCache(int id)
		{
			
			string CacheKey = "productCheckDataModel-" + id;
			...
			return (Model.productCheckData)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.productCheckData> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.productCheckData> DataTableToList(DataTable dt)
		{
			List<Model.productCheckData> modelList = new List<Model.productCheckData>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.productCheckData model;
