...
namespace BLL
{
	...
	{
		private readonly DAL.wmsProductSummaryDetail dal=new DAL.wmsProductSummaryDetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.wmsProductSummaryDetail GetModelByCache(int id)
		{
			
			string CacheKey = "wmsProductSummaryDetailModel-" + id;
			...
			return (Model.wmsProductSummaryDetail)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsProductSummaryDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.wmsProductSummaryDetail> DataTableToList(DataTable dt)
		{
			List<Model.wmsProductSummaryDetail> modelList = new List<Model.wmsProductSummaryDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.wmsProductSummaryDetail model;
