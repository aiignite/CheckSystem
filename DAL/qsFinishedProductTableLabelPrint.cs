...
{
	/// <summary>
	/// 数据访问类:qsFinishedProductTableLabelPrint
	/// </summary>
	public partial class qsFinishedProductTableLabelPrint
	{
		public qsFinishedProductTableLabelPrint()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "qsFinishedProductTableLabelPrint"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from qsFinishedProductTableLabelPrint");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.qsFinishedProductTableLabelPrint model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into qsFinishedProductTableLabelPrint(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.qsFinishedProductTableLabelPrint model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update qsFinishedProductTableLabelPrint set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from qsFinishedProductTableLabelPrint ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.qsFinishedProductTableLabelPrint GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,materialName,batchNo,minPackageNum,customerNo,boxSerialNoStart,boxSerialNoEnd,brightnessGroup,special,specialStatus,createTime,packageStyle,status,instoreStatus from qsFinishedProductTableLabelPrint ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.qsFinishedProductTableLabelPrint model=new Model.qsFinishedProductTableLabelPrint();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.qsFinishedProductTableLabelPrint DataRowToModel(DataRow row)
		{
			Model.qsFinishedProductTableLabelPrint model=new Model.qsFinishedProductTableLabelPrint();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM qsFinishedProductTableLabelPrint ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from qsFinishedProductTableLabelPrint T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "qsFinishedProductTableLabelPrint";
