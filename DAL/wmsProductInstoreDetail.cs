...
namespace DAL
{
	...
	public partial class wmsProductInstoreDetail
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductInstoreDetail"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductInstoreDetail");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductInstoreDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductInstoreDetail(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductInstoreDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductInstoreDetail set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductInstoreDetail ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Model.wmsProductInstoreDetail GetModel(int id)
		{
			...
			Model.wmsProductInstoreDetail model=new Model.wmsProductInstoreDetail();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductInstoreDetail DataRowToModel(DataRow row)
		{
			Model.wmsProductInstoreDetail model=new Model.wmsProductInstoreDetail();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsProductInstoreDetail ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductInstoreDetail T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductInstoreDetail";
