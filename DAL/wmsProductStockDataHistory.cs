...
{
	/// <summary>
	/// 数据访问类:wmsProductStockDataHistory
	/// </summary>
	public partial class wmsProductStockDataHistory
	{
		public wmsProductStockDataHistory()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductStockDataHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductStockDataHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductStockDataHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductStockDataHistory(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductStockDataHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductStockDataHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductStockDataHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductStockDataHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,storeDataNo,productNo,productCount,outStoreCount,boxNo,trayNo,shelfNo,productInstoreNo,instoreDate,productOutstoreNo,outstoreTime,status,creatTime,skNo,brightnessGroup,boxType,specific,special,productName,batchNo,stockInOperator,stockOutOperator,onShelfOperator,offShelfOperator,outtrayNo,backCount,onShelfTime,offShelfTime,offShelfNo from wmsProductStockDataHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsProductStockDataHistory model=new Model.wmsProductStockDataHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductStockDataHistory DataRowToModel(DataRow row)
		{
			Model.wmsProductStockDataHistory model=new Model.wmsProductStockDataHistory();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsProductStockDataHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductStockDataHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductStockDataHistory";
