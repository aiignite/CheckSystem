...
{
	/// <summary>
	/// 数据访问类:wmsMaterialSupplyPrintHistory
	/// </summary>
	public partial class wmsMaterialSupplyPrintHistory
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsMaterialSupplyPrintHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsMaterialSupplyPrintHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsMaterialSupplyPrintHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsMaterialSupplyPrintHistory(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsMaterialSupplyPrintHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsMaterialSupplyPrintHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsMaterialSupplyPrintHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialSupplyPrintHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,stockInNo,materialBarcode,materialNo,printNo,lotNo,count,boxNo,barcode,supplyNo,supplyLedGroup,companyGroup,note,stockInOperator,status,createTime,orderNo,supplyDate from wmsMaterialSupplyPrintHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsMaterialSupplyPrintHistory model=new Model.wmsMaterialSupplyPrintHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialSupplyPrintHistory DataRowToModel(DataRow row)
		{
			Model.wmsMaterialSupplyPrintHistory model=new Model.wmsMaterialSupplyPrintHistory();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsMaterialSupplyPrintHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsMaterialSupplyPrintHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsMaterialSupplyPrintHistory";
