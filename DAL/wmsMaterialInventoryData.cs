...
{
	/// <summary>
	/// 数据访问类:wmsMaterialInventoryData
	/// </summary>
	public partial class wmsMaterialInventoryData
	{
		public wmsMaterialInventoryData()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsMaterialInventoryData"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsMaterialInventoryData");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsMaterialInventoryData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsMaterialInventoryData(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsMaterialInventoryData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsMaterialInventoryData set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsMaterialInventoryData ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialInventoryData GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,supplierNo,boxNo,shelfNo,lotNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,inventoryDate,inventoryOperator,status,createTime,brightnessGroup,supplyLEDGroup from wmsMaterialInventoryData ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsMaterialInventoryData model=new Model.wmsMaterialInventoryData();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialInventoryData DataRowToModel(DataRow row)
		{
			Model.wmsMaterialInventoryData model=new Model.wmsMaterialInventoryData();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsMaterialInventoryData ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsMaterialInventoryData T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsMaterialInventoryData";
