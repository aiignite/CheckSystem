...
{
	/// <summary>
	/// 数据访问类:wmsMaterialInventoryDataHistory
	/// </summary>
	public partial class wmsMaterialInventoryDataHistory
	{
		public wmsMaterialInventoryDataHistory()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsMaterialInventoryDataHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsMaterialInventoryDataHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsMaterialInventoryDataHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsMaterialInventoryDataHistory(");
			strSql.Append("materialNo,supplierNo,boxNo,shelfNo,lotNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,inventoryDate,inventoryOperator,status,createTime,brightnessGroup,supplyLEDGroup)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@inventoryDate", SqlDbType.DateTime),
					new SqlParameter("@inventoryOperator", SqlDbType.NVarChar,50),
			...
			parameters[14].Value = model.inventoryDate;
			parameters[15].Value = model.inventoryOperator;
			parameters[16].Value = model.status;
			parameters[17].Value = model.createTime;
			parameters[18].Value = model.brightnessGroup;
			parameters[19].Value = model.supplyLEDGroup;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsMaterialInventoryDataHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsMaterialInventoryDataHistory set ");
			...
			strSql.Append("inventoryDate=@inventoryDate,");
			strSql.Append("inventoryOperator=@inventoryOperator,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsMaterialInventoryDataHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialInventoryDataHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,supplierNo,boxNo,shelfNo,lotNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,inventoryDate,inventoryOperator,status,createTime,brightnessGroup,supplyLEDGroup from wmsMaterialInventoryDataHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsMaterialInventoryDataHistory model=new Model.wmsMaterialInventoryDataHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialInventoryDataHistory DataRowToModel(DataRow row)
		{
			Model.wmsMaterialInventoryDataHistory model=new Model.wmsMaterialInventoryDataHistory();
			if (row != null)
			{
				...
				if(row["inventoryDate"]!=null && row["inventoryDate"].ToString()!="")
				{
					model.inventoryDate=DateTime.Parse(row["inventoryDate"].ToString());
				}
				if(row["inventoryOperator"]!=null)
				{
					model.inventoryOperator=row["inventoryOperator"].ToString();
				}
				if(row["status"]!=null)
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,materialNo,supplierNo,boxNo,shelfNo,lotNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,inventoryDate,inventoryOperator,status,createTime,brightnessGroup,supplyLEDGroup ");
			strSql.Append(" FROM wmsMaterialInventoryDataHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,materialNo,supplierNo,boxNo,shelfNo,lotNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,inventoryDate,inventoryOperator,status,createTime,brightnessGroup,supplyLEDGroup ");
			strSql.Append(" FROM wmsMaterialInventoryDataHistory ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsMaterialInventoryDataHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsMaterialInventoryDataHistory";
