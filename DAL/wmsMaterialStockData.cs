...
{
	/// <summary>
	/// 数据访问类:wmsMaterialStockData
	/// </summary>
	public partial class wmsMaterialStockData
	{
		public wmsMaterialStockData()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsMaterialStockData"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsMaterialStockData");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsMaterialStockData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsMaterialStockData(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsMaterialStockData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsMaterialStockData set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsMaterialStockData ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialStockData GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,supplierNo,boxNo,shelfNo,lotNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,status,createTime,brightnessGroup,supplyLEDGroup from wmsMaterialStockData ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsMaterialStockData model=new Model.wmsMaterialStockData();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialStockData DataRowToModel(DataRow row)
		{
			Model.wmsMaterialStockData model=new Model.wmsMaterialStockData();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsMaterialStockData ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsMaterialStockData T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsMaterialStockData";
