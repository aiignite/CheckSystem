...
{
	/// <summary>
	/// 数据访问类:wmsProductStockOutLableCheckHistory
	/// </summary>
	public partial class wmsProductStockOutLableCheckHistory
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductStockOutLableCheckHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductStockOutLableCheckHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductStockOutLableCheckHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductStockOutLableCheckHistory(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductStockOutLableCheckHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductStockOutLableCheckHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductStockOutLableCheckHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductStockOutLableCheckHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,productNo,customerNo,productCount,status,stockOutOperator,createTime,boxNumber,boxNo,shipNo from wmsProductStockOutLableCheckHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsProductStockOutLableCheckHistory model=new Model.wmsProductStockOutLableCheckHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductStockOutLableCheckHistory DataRowToModel(DataRow row)
		{
			Model.wmsProductStockOutLableCheckHistory model=new Model.wmsProductStockOutLableCheckHistory();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsProductStockOutLableCheckHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductStockOutLableCheckHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductStockOutLableCheckHistory";
