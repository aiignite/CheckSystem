...
namespace DAL
{
	...
	public partial class wmsProductInfoPrint
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductInfoPrint"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductInfoPrint");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductInfoPrint model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductInfoPrint(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductInfoPrint model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductInfoPrint set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductInfoPrint ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductInfoPrint GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,materialName,batchNo,minPackageNum,customerNo,boxSerialNoStart,boxSerialNoEnd,brightnessGroup,special,specialStatus,createTime,packageStyle,status,instoreStatus from wmsProductInfoPrint ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsProductInfoPrint model=new Model.wmsProductInfoPrint();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductInfoPrint DataRowToModel(DataRow row)
		{
			Model.wmsProductInfoPrint model=new Model.wmsProductInfoPrint();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsProductInfoPrint ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductInfoPrint T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductInfoPrint";
