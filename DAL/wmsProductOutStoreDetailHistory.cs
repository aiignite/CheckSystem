...
{
	/// <summary>
	/// 数据访问类:wmsProductOutStoreDetailHistory
	/// </summary>
	public partial class wmsProductOutStoreDetailHistory
	{
		public wmsProductOutStoreDetailHistory()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductOutStoreDetailHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductOutStoreDetailHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductOutStoreDetailHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductOutStoreDetailHistory(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductOutStoreDetailHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductOutStoreDetailHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductOutStoreDetailHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductOutStoreDetailHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,outStoreDetailNo,productOutStoreNo,productNo,productCount,outstoreCount,boxNo,trayNo,shelfNo,status,skNo,brightnessGroup,boxType,specific,special,productName,creater,createTime,offShelfOperator,offShelfTime,outStoreOperator,outStoreTime,batchNo,acceptCustomer,priority from wmsProductOutStoreDetailHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsProductOutStoreDetailHistory model=new Model.wmsProductOutStoreDetailHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductOutStoreDetailHistory DataRowToModel(DataRow row)
		{
			Model.wmsProductOutStoreDetailHistory model=new Model.wmsProductOutStoreDetailHistory();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsProductOutStoreDetailHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductOutStoreDetailHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductOutStoreDetailHistory";
