...
namespace DAL
{
	...
	public partial class deviceSMSInfo
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "deviceSMSInfo"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from deviceSMSInfo");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.deviceSMSInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into deviceSMSInfo(");
			strSql.Append("repairNo,deviceNo,failureDetail,repairDetail,onTime,offTime,repairer,lessonNote,status,smsStatus,dealer,creater,createTime)");
			...
			parameters[9].Value = model.smsStatus;
			parameters[10].Value = model.dealer;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.deviceSMSInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update deviceSMSInfo set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from deviceSMSInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.deviceSMSInfo GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,repairNo,deviceNo,failureDetail,repairDetail,onTime,offTime,repairer,lessonNote,status,smsStatus,dealer,creater,createTime from deviceSMSInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.deviceSMSInfo model=new Model.deviceSMSInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.deviceSMSInfo DataRowToModel(DataRow row)
		{
			Model.deviceSMSInfo model=new Model.deviceSMSInfo();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,repairNo,deviceNo,failureDetail,repairDetail,onTime,offTime,repairer,lessonNote,status,smsStatus,dealer,creater,createTime ");
			strSql.Append(" FROM deviceSMSInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,repairNo,deviceNo,failureDetail,repairDetail,onTime,offTime,repairer,lessonNote,status,smsStatus,dealer,creater,createTime ");
			strSql.Append(" FROM deviceSMSInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from deviceSMSInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "deviceSMSInfo";
