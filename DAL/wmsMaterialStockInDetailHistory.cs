...
{
	/// <summary>
	/// 数据访问类:wmsMaterialStockInDetailHistory
	/// </summary>
	public partial class wmsMaterialStockInDetailHistory
	{
		public wmsMaterialStockInDetailHistory()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsMaterialStockInDetailHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsMaterialStockInDetailHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsMaterialStockInDetailHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsMaterialStockInDetailHistory(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsMaterialStockInDetailHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsMaterialStockInDetailHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsMaterialStockInDetailHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialStockInDetailHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,stockInNo,materialBarcode,materialNo,printNo,lotNo,count,boxNo,barcode,supplyNo,supplyLedGroup,companyGroup,note,stockInOperator,status,createTime,orderNo,supplyDate from wmsMaterialStockInDetailHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsMaterialStockInDetailHistory model=new Model.wmsMaterialStockInDetailHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsMaterialStockInDetailHistory DataRowToModel(DataRow row)
		{
			Model.wmsMaterialStockInDetailHistory model=new Model.wmsMaterialStockInDetailHistory();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsMaterialStockInDetailHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsMaterialStockInDetailHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsMaterialStockInDetailHistory";
