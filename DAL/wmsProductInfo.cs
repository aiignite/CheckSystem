...
namespace DAL
{
	...
	public partial class wmsProductInfo
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductInfo"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductInfo");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductInfo(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductInfo set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductInfo GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,productNo,productName,productModel,productNo2,productMinPackageNum,projectNo,productStatus,isValid,creater,createTime from wmsProductInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsProductInfo model=new Model.wmsProductInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductInfo DataRowToModel(DataRow row)
		{
			Model.wmsProductInfo model=new Model.wmsProductInfo();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsProductInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductInfo";
