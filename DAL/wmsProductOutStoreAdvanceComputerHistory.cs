...
{
	/// <summary>
	/// 数据访问类:wmsProductOutStoreAdvanceComputerHistory
	/// </summary>
	public partial class wmsProductOutStoreAdvanceComputerHistory
	{
		public wmsProductOutStoreAdvanceComputerHistory()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductOutStoreAdvanceComputerHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductOutStoreAdvanceComputerHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductOutStoreAdvanceComputerHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductOutStoreAdvanceComputerHistory(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductOutStoreAdvanceComputerHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductOutStoreAdvanceComputerHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductOutStoreAdvanceComputerHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductOutStoreAdvanceComputerHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,customerNo,customerNeedCount,productNo,productName,storeCount,difference,brightnessGroup,boxType,specific,special,status,outStoreNo,batchNo,creater,createTime,acceptCustomer,priority,memo1 from wmsProductOutStoreAdvanceComputerHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsProductOutStoreAdvanceComputerHistory model=new Model.wmsProductOutStoreAdvanceComputerHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductOutStoreAdvanceComputerHistory DataRowToModel(DataRow row)
		{
			Model.wmsProductOutStoreAdvanceComputerHistory model=new Model.wmsProductOutStoreAdvanceComputerHistory();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wmsProductOutStoreAdvanceComputerHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductOutStoreAdvanceComputerHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductOutStoreAdvanceComputerHistory";
