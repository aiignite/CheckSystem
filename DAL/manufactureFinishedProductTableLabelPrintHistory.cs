...
{
	/// <summary>
	/// 数据访问类:manufactureFinishedProductTableLabelPrintHistory
	/// </summary>
	public partial class manufactureFinishedProductTableLabelPrintHistory
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "manufactureFinishedProductTableLabelPrintHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from manufactureFinishedProductTableLabelPrintHistory");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.manufactureFinishedProductTableLabelPrintHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into manufactureFinishedProductTableLabelPrintHistory(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.manufactureFinishedProductTableLabelPrintHistory model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update manufactureFinishedProductTableLabelPrintHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from manufactureFinishedProductTableLabelPrintHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.manufactureFinishedProductTableLabelPrintHistory GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,materialName,batchNo,minPackageNum,customerNo,boxSerialNoStart,boxSerialNoEnd,brightnessGroup,special,specialStatus,createTime,packageStyle,status,instoreStatus,creater,productCount,boxCount,instoreReceiptCount,pcNo,instoreReceiptStart from manufactureFinishedProductTableLabelPrintHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.manufactureFinishedProductTableLabelPrintHistory model=new Model.manufactureFinishedProductTableLabelPrintHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.manufactureFinishedProductTableLabelPrintHistory DataRowToModel(DataRow row)
		{
			Model.manufactureFinishedProductTableLabelPrintHistory model=new Model.manufactureFinishedProductTableLabelPrintHistory();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM manufactureFinishedProductTableLabelPrintHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from manufactureFinishedProductTableLabelPrintHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "manufactureFinishedProductTableLabelPrintHistory";
