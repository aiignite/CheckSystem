...
{
	/// <summary>
	/// 数据访问类:wmsSparePartsStockData
	/// </summary>
	public partial class wmsSparePartsStockData
	{
		public wmsSparePartsStockData()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsSparePartsStockData"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsSparePartsStockData");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsSparePartsStockData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsSparePartsStockData(");
			strSql.Append("materialNo,supplierNo,boxNo,shelfNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,status,createTime)");
			...
			parameters[7].Value = model.stockInNo;
			parameters[8].Value = model.stockInDate;
			parameters[9].Value = model.stockInOperator;
			parameters[10].Value = model.stockOutNo;
			parameters[11].Value = model.stockOutDate;
			parameters[12].Value = model.stockOutOperator;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsSparePartsStockData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsSparePartsStockData set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsSparePartsStockData ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsSparePartsStockData GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,supplierNo,boxNo,shelfNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,status,createTime from wmsSparePartsStockData ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsSparePartsStockData model=new Model.wmsSparePartsStockData();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsSparePartsStockData DataRowToModel(DataRow row)
		{
			Model.wmsSparePartsStockData model=new Model.wmsSparePartsStockData();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,materialNo,supplierNo,boxNo,shelfNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,status,createTime ");
			strSql.Append(" FROM wmsSparePartsStockData ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,materialNo,supplierNo,boxNo,shelfNo,count,note,barcode,stockInNo,stockInDate,stockInOperator,stockOutNo,stockOutDate,stockOutOperator,status,createTime ");
			strSql.Append(" FROM wmsSparePartsStockData ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsSparePartsStockData T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsSparePartsStockData";
