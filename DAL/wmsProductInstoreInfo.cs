...
{
	/// <summary>
	/// 数据访问类:wmsProductInstoreInfo
	/// </summary>
	public partial class wmsProductInstoreInfo
	{
		public wmsProductInstoreInfo()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wmsProductInstoreInfo"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wmsProductInstoreInfo");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.wmsProductInstoreInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wmsProductInstoreInfo(");
			strSql.Append("productInStoreNo,productNo,productName,productCount,instoreCount,boxCount,operatorNo,customerNo,brightnessGroup,boxType,specific,special,type,status,creater,createtime,receiver,receiveTime,outStockType,batchNo,receiptNo,UpdateMan,UpdateDate)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.wmsProductInstoreInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wmsProductInstoreInfo set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wmsProductInstoreInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductInstoreInfo GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,productInStoreNo,productNo,productName,productCount,instoreCount,boxCount,operatorNo,customerNo,brightnessGroup,boxType,specific,special,type,status,creater,createtime,receiver,receiveTime,outStockType,batchNo,receiptNo,UpdateMan,UpdateDate from wmsProductInstoreInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.wmsProductInstoreInfo model=new Model.wmsProductInstoreInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.wmsProductInstoreInfo DataRowToModel(DataRow row)
		{
			Model.wmsProductInstoreInfo model=new Model.wmsProductInstoreInfo();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,productInStoreNo,productNo,productName,productCount,instoreCount,boxCount,operatorNo,customerNo,brightnessGroup,boxType,specific,special,type,status,creater,createtime,receiver,receiveTime,outStockType,batchNo,receiptNo,UpdateMan,UpdateDate ");
			strSql.Append(" FROM wmsProductInstoreInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,productInStoreNo,productNo,productName,productCount,instoreCount,boxCount,operatorNo,customerNo,brightnessGroup,boxType,specific,special,type,status,creater,createtime,receiver,receiveTime,outStockType,batchNo,receiptNo,UpdateMan,UpdateDate ");
			strSql.Append(" FROM wmsProductInstoreInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wmsProductInstoreInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wmsProductInstoreInfo";
