...
{
	/// <summary>
	/// 数据访问类:manufactureSampleTableLabelPrint
	/// </summary>
	public partial class manufactureSampleTableLabelPrint
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "manufactureSampleTableLabelPrint"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from manufactureSampleTableLabelPrint");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.manufactureSampleTableLabelPrint model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into manufactureSampleTableLabelPrint(");
			strSql.Append("materialNo,materialName,batchNo,minPackageNum,customerNo,boxSerialNoStart,boxSerialNoEnd,brightnessGroup,special,specialStatus,createTime,packageStyle,status,instoreStatus,creater,pcNo,instoreReceiptStart,productCount,boxCount,instoreReceiptCount)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@boxCount", SqlDbType.NVarChar,50),
			...
			parameters[15].Value = model.pcNo;
			parameters[16].Value = model.instoreReceiptStart;
			parameters[17].Value = model.productCount;
			parameters[18].Value = model.boxCount;
			parameters[19].Value = model.instoreReceiptCount;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.manufactureSampleTableLabelPrint model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update manufactureSampleTableLabelPrint set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from manufactureSampleTableLabelPrint ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.manufactureSampleTableLabelPrint GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,materialNo,materialName,batchNo,minPackageNum,customerNo,boxSerialNoStart,boxSerialNoEnd,brightnessGroup,special,specialStatus,createTime,packageStyle,status,instoreStatus,creater,pcNo,instoreReceiptStart,productCount,boxCount,instoreReceiptCount from manufactureSampleTableLabelPrint ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.manufactureSampleTableLabelPrint model=new Model.manufactureSampleTableLabelPrint();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.manufactureSampleTableLabelPrint DataRowToModel(DataRow row)
		{
			Model.manufactureSampleTableLabelPrint model=new Model.manufactureSampleTableLabelPrint();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,materialNo,materialName,batchNo,minPackageNum,customerNo,boxSerialNoStart,boxSerialNoEnd,brightnessGroup,special,specialStatus,createTime,packageStyle,status,instoreStatus,creater,pcNo,instoreReceiptStart,productCount,boxCount,instoreReceiptCount ");
			strSql.Append(" FROM manufactureSampleTableLabelPrint ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,materialNo,materialName,batchNo,minPackageNum,customerNo,boxSerialNoStart,boxSerialNoEnd,brightnessGroup,special,specialStatus,createTime,packageStyle,status,instoreStatus,creater,pcNo,instoreReceiptStart,productCount,boxCount,instoreReceiptCount ");
			strSql.Append(" FROM manufactureSampleTableLabelPrint ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from manufactureSampleTableLabelPrint T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "manufactureSampleTableLabelPrint";
