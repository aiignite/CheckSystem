...
{
    public partial class FormEditDeviceConfigController : Form
    {
        private DeviceConfigController _controller;
        public FormEditDeviceConfigController()
        {
            InitializeComponent();
            OtherPropertiesInit();
        }

        public FormEditDeviceConfigController(object obj)
        {
            InitializeComponent();
            OtherPropertiesInit();
            _controller = (DeviceConfigController)obj;
        }

        private void FormEditDeviceConfigController_Load(object sender, EventArgs e)
        {
            ControlsInit();
            ToolStripInit();
        }
        ...
        private void ControlsInit()
        {
            ...
            lcmbControllers.Text = _controller.Type;

            ltName.label.Text = "名称";
            ltName.Dock = DockStyle.Top;
            ltName.Text = _controller.Name;

            ltNote.label.Text = "说明";
            ltNote.Dock = DockStyle.Top;
            ltNote.Text = _controller.Note;
