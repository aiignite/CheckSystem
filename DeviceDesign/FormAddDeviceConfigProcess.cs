...
{
    public partial class FormAddDeviceConfigProcess : Form
    {
        public FormAddDeviceConfigProcess()
        {
            InitializeComponent();
            OtherPropertiesInit();
        }

        private void FormAddDeviceConfigProcess_Load(object sender, EventArgs e)
        {
            ControlsInit();
            ToolStripInit();
        }
        ...
        private void ToolStripButtonSave_Click(object sender, EventArgs e)
        {
            ...
            var item = lst.Find(t => t.No == ltNo.Text );
            if (item != null)
            {
                MessageBox.Show("已经包含该工序编号");
                return;
            }
