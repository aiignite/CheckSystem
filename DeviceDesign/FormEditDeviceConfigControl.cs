...
{
    public partial class FormEditDeviceConfigControl : Form
    {
        private DeviceConfigControl _control = new DeviceConfigControl();

        public FormEditDeviceConfigControl()
        {
            InitializeComponent();
            OtherPropertiesInit();
        }
        public FormEditDeviceConfigControl(object obj)
        {
            InitializeComponent();
            OtherPropertiesInit();
            _control = (DeviceConfigControl)obj;

        }

        private void FormEditDeviceConfigControl_Load(object sender, EventArgs e)
        {
            ControlsInit();
            ToolStripInit();
        }
        ...
        private void ToolStripButtonSave_Click(object sender, EventArgs e)
        {
            ...
            var prop = lst.Find(t => t.Name == _control.Name && t.Type == _control.Type);
