...
{
    public partial class FormEditDeviceConfigPart : Form
    {
        private DeviceConfigPart _part = new DeviceConfigPart();

        public FormEditDeviceConfigPart()
        {
            InitializeComponent();
            OtherPropertiesInit();
        }

        public FormEditDeviceConfigPart(object obj)
        {
            InitializeComponent();
            OtherPropertiesInit();
            _part = (DeviceConfigPart)obj;
        }

        private void FormEditDeviceConfigPart_Load(object sender, EventArgs e)
        {
            ControlsInit();
            ToolStripInit();
        }
        ...
        private void ToolStripButtonSave_Click(object sender, EventArgs e)
        {
            ...
            var item = lst.Find(t => t.Name == _part.Name && t.ProcessNo == lcmbProcessNo.Text);
        ...
        private void ControlsInit()
        {
            ...
            ltName.Text = _part.Name;
            lcmbControllerField.Text = _part.ControllerField;
            lcmbControllerName.Text = _part.ControllerName;
            lcmbDataType.Text = _part.DataType;
            lcmbProcessNo.Text = _part.ProcessNo;
