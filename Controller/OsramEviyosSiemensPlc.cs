...
{
    public sealed class OsramEviyosSiemensPlc : ControllerBase
    {
        ...
        //public ushort ReadMaxLenth = 4;
        //public ushort ReadStartAddr = 257;
        //public ushort WriteStartAddr = 289;


        public ushort ReadMaxLenth = 10;
        public ushort ReadStartAddr = 10;
        ...
        [Description("R/W,Hr40257")]
        public ushort Hr40257;
        [Description("R/W,Hr40258")]
        public ushort Hr40258;
        [Description("R/W,Hr40259")]
        ...
        [Description("R/W,Hr40289")]
        public ushort Hr40289;
        [Description("R/W,Hr40290")]
        public ushort Hr40290;
        [Description("R/W,Hr40291")]
        public ushort Hr40291;
        [Description("R/W,Hr4092")]
        ...
        public OsramEviyosSiemensPlc(string name) :
            base(name) { }

        ~OsramEviyosSiemensPlc()
        {
            Dispose();
        }
        ...
        private void Daemon()
        {
            ...
            while (_daemonTh.IsAlive)
            {
                ...
                var readHoldingRegs = _sienmensModbusTcpNet.Read(ReadStartAddr.ToString(),
                    ReadMaxLenth > 4 ? (ushort)8 : ReadMaxLenth);
                ...
                //    continue;
                {
                    ...
                    for (var i = startAddr; i < startAddr + 8; i++)
                    {
