...
{
    [Description("CAN-Product,P12L高配前灯")]
    public sealed class P12LHighLevelHeadLamp : ControllerBase
    {
        ...
        public P12LHighLevelHeadLamp(string name)
            : base(name)
        {
        ...
        //private byte[] _leftTurnGray = new byte[8];
        //private byte[] _rightTurnGray = new byte[8];
        //private byte[] _leftLedGray = new byte[(0x10C - 0x101 + 1) * 8];
        //private byte[] _rightLedGray = new byte[(0x20C - 0x201 + 1) * 8];
        private readonly byte[] _turnGray = new byte[8];
        private readonly byte[] _ledGray = new byte[(0x10C - 0x101 + 1) * 8];
