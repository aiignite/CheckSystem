...
{
    public sealed class WirelessAllLedAutoAssemblyController : ControllerBase
    {
        public WirelessAllLedAutoAssemblyController(string name) :
            base(name)
        {
        ...
        public string B2 = string.Empty;
        public string B3 = string.Empty;
        public string B4 = string.Empty;
            ...
            lock (_lockBarcode)
            {
                ...
                if (Exists(strSql.ToString(), parameters))
                {
                    ...
                    if (ds.Tables[0].DefaultView.Count > 0)
                    {
                        ...
                        B1 = ds.Tables[0].DefaultView[0]["Product1Barcode"] == null
                           ? string.Empty
                           : ds.Tables[0].DefaultView[0]["Product1Barcode"].ToString();

                        B2 = ds.Tables[0].DefaultView[0]["Product2Barcode"] == null
                            ? string.Empty
                            : ds.Tables[0].DefaultView[0]["Product2Barcode"].ToString();

                        B3 = ds.Tables[0].DefaultView[0]["Product3Barcode"] == null
                            ? string.Empty
                            : ds.Tables[0].DefaultView[0]["Product3Barcode"].ToString();

                        B4 = ds.Tables[0].DefaultView[0]["Product4Barcode"] == null
                           ? string.Empty
                           : ds.Tables[0].DefaultView[0]["Product4Barcode"].ToString();
                    }
                }
