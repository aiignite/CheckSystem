...
{
    public sealed class CcdAutoAssemblySiemensPlc : ControllerBase
    {
        ...
        public ushort ReadMaxLenth = 50;
        public ushort ReadStartAddr = 0;
        public ushort WriteStartAddr = 50;
        ...
        [Description("R/W,Hr40051")]
        public ushort Hr40051;
        [Description("R/W,Hr40052")]
        public ushort Hr40052;
        [Description("R/W,Hr40053")]
        public ushort Hr40053;
        [Description("R/W,Hr40054")]
        public ushort Hr40054;
        [Description("R/W,Hr40055")]
        public ushort Hr40055;
        [Description("R/W,Hr40056")]
        public ushort Hr40056;
        [Description("R/W,Hr40057")]
        ...
        [Description("R/W,Hr40068")]
        public ushort Hr40068;
        public ushort Hr40069;
        [Description("R/W,Hr40070")]
        ...
        public CcdAutoAssemblySiemensPlc(string name) :
            base(name) { }

        ~CcdAutoAssemblySiemensPlc()
        {
            Dispose();
        }
        ...
        private void Daemon()
        {
            ...
            while (_daemonTh.IsAlive)
            {
                ...
                var readHoldingRegs = _sienmensModbusTcpNet.Read(ReadStartAddr.ToString(),
                    ReadMaxLenth > 50 ? (ushort)50 : ReadMaxLenth);
        ...
        public void SetSpeed(int speed)
        {
            ...
            byte[] byte_i = BitConverter.GetBytes(speed);//此函数将十进制转为四个字节的十六进制
            pack[0] = byte_i[1];
            pack[1] = byte_i[0];
            Hr40059 = Convert.ToUInt16(speed / 65536);
            Hr40060 = Convert.ToUInt16(speed % 65536);
            //Hr40060 = Convert.ToUInt16(pack[0]);
            //Hr40059 = Convert.ToUInt16(pack[1]);
        }
        ...
        {
            byte[] pack = new byte[2];
            byte[] byte_i = BitConverter.GetBytes(width);//此函数将十进制转为四个字节的十六进制
            pack[0] = byte_i[1];
            pack[1] = byte_i[0];
            //Hr40057 = Convert.ToUInt16(pack[0]);
            //Hr40058 = Convert.ToUInt16(pack[1]);
         
            
            //Hr40059 = Convert.ToUInt16(width/65536);
            //Hr40060 = Convert.ToUInt16(width % 65536);

            Hr40059 = Convert.ToUInt16(width);
        }
