...
{
    public sealed class CcdAutoAssemblyController : ControllerBase
    {
        public CcdAutoAssemblyController(string name) : base(name) { }
        ...
        public void DebugReadLoadPlateState()
        {
            ReadLoadPlateState();

            LoadPlateProduct1State = 1;
            LoadPlateProduct2State = 1;
            LoadPlateProduct3State = 0;
            LoadPlateProduct4State = 1;
            LoadPlateProduct1Barcode = "P123456789123456789123456789123456001";
            LoadPlateProduct2Barcode = "P123456789123456789123456789123456002";
            LoadPlateProduct3Barcode = "P123456789123456789123456789123456003";
            LoadPlateProduct4Barcode = "P123456789123456789123456789123456004";
            LoadPlateProductPartNo = "P00104733";
            LoadPlateProductNo = "PR4101000605";
            ...
            var loadPlateProductPartBytes = new byte[10];
            Array.Copy(Encoding.ASCII.GetBytes(LoadPlateProductPartNo), loadPlateProductPartBytes,
               Encoding.ASCII.GetBytes(LoadPlateProductPartNo).Length);
            _hr40116 = (ushort)(loadPlateProductPartBytes[0] * 256 + loadPlateProductPartBytes[1]);
            _hr40117 = (ushort)(loadPlateProductPartBytes[2] * 256 + loadPlateProductPartBytes[3]);
            _hr40118 = (ushort)(loadPlateProductPartBytes[4] * 256 + loadPlateProductPartBytes[5]);
            _hr40119 = (ushort)(loadPlateProductPartBytes[6] * 256 + loadPlateProductPartBytes[7]);
        ...
        public void PrintBarcode5(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode6(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode7(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode8(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode9(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode10(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode11(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode12(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode13(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode14(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode15(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        public void PrintBarcode16(string filePath)
        {
            try
            {
                lock (_lockBarcode)
        ...
        private static void WriteTxt(string filePath, string value, bool istrue)
        {
            try
            {
        ...
        private static void WriteTxt1(string filePath, string value, bool istrue)
        {
            try
            {
                var lines = File.ReadAllLines(filePath);
                ...
                try
                {
                    ...
                    matrixBytes.AddRange(Encoding.ASCII.GetBytes(sp[0])); // 通用VPPS号
                    matrixBytes.Add(0x1D); //<GS>
                    matrixBytes.AddRange(Encoding.ASCII.GetBytes("P" + sp[1])); //  P+通用零件号
                    matrixBytes.Add(0x1D); //<GS>
                    matrixBytes.AddRange(Encoding.ASCII.GetBytes("12V" + sp[2])); //  12V+DUNS邓氏码
                    matrixBytes.Add(0x1D); //<GS>

                    matrixBytes.AddRange(Encoding.ASCII.GetBytes("T" + sp[3])); //  追溯码
                    matrixBytes.AddRange(new byte[] { 0x1E, 0x04 }); // trailer <RS>

                    newBarcode = matrixBytes.ToArray().GetStringByAsciiBytes(false);
                    ...
                    list.Add(sp[1].Substring(0, 4));
                    list.Add(sp[1].Substring(4, 4));
                    list.Add(sp[0]);
                    list.Add(sp[2]);
                    list.Add(sp[3]);
                    list.Add("Made in China");
                    list.Add(newBarcode);
                ...
                //string[] barcodes = Regex.Split(newBarcode, Encoding.ASCII.GetString(new byte[] { 0x1D }),
                //    RegexOptions.IgnoreCase);
                //var code = newBarcode;
                //string PartNo0 = barcodes[2].Substring(0,4);
                //string PartNo1 = barcodes[2].Substring(4, 4);
                //string VVPS = barcodes[1];
                //string DUNS = barcodes[3];
                //string Retrospect = barcodes[4];
                //string ProdectPlae = "Made in China";
                //list.Add(PartNo0);
                //list.Add(PartNo1);
                //list.Add(VVPS);
                //list.Add(DUNS);
                //list.Add(Retrospect);
                //list.Add(ProdectPlae);
                //list.Add(newBarcode);
                //lines = list.ToArray();    
                if (istrue)
                {
        ...
        public void GenerateWirelessChargingBarcode(string partNo, string changeRecord, string swVer)
        {
            ...
            else
            {
                ...
                LoadPlateProduct2Barcode = barcodeList[1];
                LoadPlateProduct3Barcode = barcodeList[2];
                LoadPlateProduct4Barcode = barcodeList[3];
        ...
        private Object clientObj = new object();
        ...
        public void ClientWrite2(string msg)    // 框架问题特殊字符无法发送先转16进制
        {
        ...
        public void ClientWriteState()
        {
            StringBuilder stringBuilder = new StringBuilder();
            temp.Add(LoadPlateProduct1state);
            temp.Add(LoadPlateProduct2state);
            temp.Add(LoadPlateProduct3state);
            temp.Add(LoadPlateProduct4state);
            temp.Add(LoadPlateProduct5state);
            temp.Add(LoadPlateProduct6state);
            temp.Add(LoadPlateProduct7state);
            temp.Add(LoadPlateProduct8state);
            for (int i = 0; i < temp.Count; i++)
            {
                stringBuilder.Append(temp[i]);
            }
            client.Write(stringBuilder.ToString());
            temp.Clear();
        }

        List<string> SplitBarcodeList = new List<string>();
        Dictionary<int, string> BarcodeList = new Dictionary<int, string>();
        public string ClientReceive = "";

        public int Barcode1XMin = (4396 - 200);
        public int Barcode1XMax = (4396 - 200);
        public int Barcode1YMin = (2392 - 200);
        public int Barcode1YMax = (2392 + 200);

        public int Barcode2XMin = (1090 - 200);
        public int Barcode2XMax = (1090 + 200);
        public int Barcode2YMin = (2390 - 200);
        public int Barcode2YMax = (2390 + 200);

        public int Barcode3XMin = (3489 - 200);
        public int Barcode3XMax = (3489 + 200);
        public int Barcode3YMin = (2743 - 200);
        public int Barcode3YMax = (2743 + 200);

        public int Barcode4XMin = (1994 - 200);
        public int Barcode4XMax = (1994 + 200);
        public int Barcode4YMin = (2753 - 200);
        public int Barcode4YMax = (2753 + 200);

        public int MaxScanCodeCount = 4;

        private readonly object _lockBarcodeBuff = new object();
        ...
        private void Client_DataReceived(object sender, SimpleTCP.Message e)
        {
            try
            {
                ...
                if (_nhkip.StartsWith("192.168.1.42"))
                {
                    Console.Write("");
                }

                if (e.MessageString.Contains(";") && e.MessageString.Split(';').Length >= MaxScanCodeCount && !e.MessageString.Contains("NoRead"))
                {
                    SplitBarcodeList = e.MessageString.Split(';').ToList<string>();
                    SplitBarcodeList = e.MessageString.Replace("(", "").Replace(")", "").Split(';').ToList<string>();

                    var maxCount = MaxScanCodeCount >= 1 && MaxScanCodeCount <= 4 ? MaxScanCodeCount : 1;

                    if (SplitBarcodeList.Count == maxCount)
                    {
                        for (var i = 0; i < SplitBarcodeList.Count; i++)
                        {
                            for (int j = 0; j < SplitBarcodeList[i].Split(',').Length; j++)
                            {
                                var x = Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]);
                                var y = Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]);
                                var barcode= SplitBarcodeList[i].Split(',')[2];

                                if (maxCount >= 1 && x >= Barcode1XMin && x <= Barcode1XMax && y >= Barcode1YMin && y <= Barcode1YMax && string.IsNullOrEmpty(LoadPlateProduct1CompleteBarcodeA))
                                {
                                    lock (_lockBarcodeBuff)
                                    {
                                        LoadPlateProduct1CompleteBarcodeA = barcode;
                                        GetProduct1BarcodeList.Add(LoadPlateProduct1CompleteBarcodeA);
                                    }
                                }

                                if (maxCount >= 2 && x >= Barcode2XMin && x <= Barcode2XMax && y >= Barcode2YMin && y <= Barcode2YMax && string.IsNullOrEmpty(LoadPlateProduct2CompleteBarcodeA))
                                {
                                    lock (_lockBarcodeBuff)
                                    {
                                        LoadPlateProduct2CompleteBarcodeA = barcode;
                                        GetProduct2BarcodeList.Add(LoadPlateProduct2CompleteBarcodeA);
                                    }
                                }

                                if (maxCount >= 3 && x >= Barcode3XMin && x <= Barcode3XMax && y >= Barcode3YMin && y <= Barcode3YMax && string.IsNullOrEmpty(LoadPlateProduct3CompleteBarcodeA))
                                {
                                    lock (_lockBarcodeBuff)
                                    {
                                        LoadPlateProduct3CompleteBarcodeA = barcode;
                                        GetProduct3BarcodeList.Add(LoadPlateProduct3CompleteBarcodeA);
                                    }
                                }

                                if (maxCount >= 4 && x >= Barcode4XMin && x <= Barcode4XMax && y >= Barcode4YMin && y <= Barcode4YMax && string.IsNullOrEmpty(LoadPlateProduct4CompleteBarcodeA))
                                {
                                    lock (_lockBarcodeBuff)
                                    {
                                        LoadPlateProduct4CompleteBarcodeA = barcode;
                                        GetProduct1BarcodeList.Add(LoadPlateProduct4CompleteBarcodeA);
                                    }
                                }
                            ...
                            //if (maxCount >= 1)
                            //{
                            //    if (Barcode1XMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) < Barcode1XMax
                            //        && Barcode1YMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) < Barcode1YMax)
                            //    {
                            ...
                            //if (maxCount >= 2)
                            //{
                            //    if (Barcode2XMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) < Barcode2XMax
                            //        && Barcode2YMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) < Barcode2YMax)
                            //    {
                            //        lock (_lockBarcodeBuff)
                            //        {
                            //            LoadPlateProduct2CompleteBarcodeA = SplitBarcodeList[i].Split(',')[2];
                            //            GetProduct2BarcodeList.Add(LoadPlateProduct2CompleteBarcodeA);
                            //        }
                            //    }
                            //}
                            ...
                            //if (maxCount >= 3)
                            //{
                            //    if (Barcode3XMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) < Barcode3XMax
                            //        && Barcode3YMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) < Barcode3YMax)
                            //    {
                            //        lock (_lockBarcodeBuff)
                            //        {
                            //            LoadPlateProduct3CompleteBarcodeA = SplitBarcodeList[i].Split(',')[2];
                            //            GetProduct3BarcodeList.Add(LoadPlateProduct3CompleteBarcodeA);
                            //        }
                            //    }
                            //}
                            ...
                            //if (maxCount >= 4)
                            //{
                            //    if (Barcode4XMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[0]) < Barcode4XMax
                            //        && Barcode4YMin < Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) && Convert.ToInt32(SplitBarcodeList[i].Split(',')[1]) < Barcode4YMax)
                            //    {
                            //        lock (_lockBarcodeBuff)
                            //        {
                            //            LoadPlateProduct4CompleteBarcodeA = SplitBarcodeList[i].Split(',')[2];
                            //            GetProduct4BarcodeList.Add(LoadPlateProduct4CompleteBarcodeA);
                            //        }
                            //    }
                            //}
                            ...
                            if (maxCount == 1)
                            {
                                if (LoadPlateProduct1CompleteBarcodeA != null && LoadPlateProduct1CompleteBarcodeA != string.Empty
                               )
                                {
                                    IsGetBar = true;
                                    SplitBarcodeList.Clear();
                                    BarcodeList.Clear();
                                }
                            }
                            else if (maxCount == 2)
                            {
                                if (LoadPlateProduct1CompleteBarcodeA != null && LoadPlateProduct2CompleteBarcodeA != null &&
                                    LoadPlateProduct1CompleteBarcodeA != string.Empty && LoadPlateProduct2CompleteBarcodeA != string.Empty
                               )
                                {
                                    IsGetBar = true;
                                    SplitBarcodeList.Clear();
                            ...
                            {
                                if (LoadPlateProduct1CompleteBarcodeA != null && LoadPlateProduct2CompleteBarcodeA != null && LoadPlateProduct3CompleteBarcodeA != null &&
                                    LoadPlateProduct1CompleteBarcodeA != string.Empty && LoadPlateProduct2CompleteBarcodeA != string.Empty && LoadPlateProduct3CompleteBarcodeA != string.Empty)
                                {
                                    IsGetBar = true;
                                    SplitBarcodeList.Clear();
                                    BarcodeList.Clear();
                            ...
                            {
                                if (LoadPlateProduct1CompleteBarcodeA != null && LoadPlateProduct2CompleteBarcodeA != null && LoadPlateProduct3CompleteBarcodeA != null && LoadPlateProduct4CompleteBarcodeA != null
                               && LoadPlateProduct1CompleteBarcodeA != string.Empty && LoadPlateProduct2CompleteBarcodeA != string.Empty && LoadPlateProduct3CompleteBarcodeA != string.Empty && LoadPlateProduct4CompleteBarcodeA != string.Empty
                               )
                                {
                                    IsGetBar = true;
                                    SplitBarcodeList.Clear();
        ...
        public void GetProductBarcode()
        {
            try
            {
                if (MaxScanCodeCount == 1)
                {
                    LoadPlateProduct1CompleteBarcode = string.Empty;
                    lock (_lockBarcodeBuff)
                    {
                        if (GetProduct1BarcodeList.Count != 0)
                        {
                            LoadPlateProduct1CompleteBarcode = GetProduct1BarcodeList[0];
                            GetProduct1BarcodeList.RemoveAt(0);
                        }
                    }
                }
                else if (MaxScanCodeCount == 2)
                {
                    LoadPlateProduct1CompleteBarcode = string.Empty;
                    lock (_lockBarcodeBuff)
                    {
                    ...
                    LoadPlateProduct2CompleteBarcode = string.Empty;
                    lock (_lockBarcodeBuff)
                    {
                        if (GetProduct2BarcodeList.Count != 0)
                        {
                            LoadPlateProduct2CompleteBarcode = GetProduct2BarcodeList[0];
                            GetProduct2BarcodeList.RemoveAt(0);
                        }
                    }
                }
                else if (MaxScanCodeCount == 3)
                {
                    LoadPlateProduct1CompleteBarcode = string.Empty;
                    lock (_lockBarcodeBuff)
                    {
                    ...
                    LoadPlateProduct3CompleteBarcode = string.Empty;
                    lock (_lockBarcodeBuff)
                    {
                        if (GetProduct3BarcodeList.Count != 0)
                        {
                            LoadPlateProduct3CompleteBarcode = GetProduct3BarcodeList[0];
                            GetProduct3BarcodeList.RemoveAt(0);
                        }
                    }
                }
                else if (MaxScanCodeCount == 4)
                {
                    LoadPlateProduct1CompleteBarcode = string.Empty;
                    lock (_lockBarcodeBuff)
                    {
                    ...
                    LoadPlateProduct4CompleteBarcode = string.Empty;
                    lock (_lockBarcodeBuff)
                    {
                        if (GetProduct4BarcodeList.Count != 0)
                        {
                            LoadPlateProduct4CompleteBarcode = GetProduct4BarcodeList[0];
                            GetProduct4BarcodeList.RemoveAt(0);
                        }
                    }
                }
            }
        ...
        {
            IsGetBar = false;
            //LoadPlateProduct1CompleteBarcode = null;
            //LoadPlateProduct2CompleteBarcode = null;
            //LoadPlateProduct3CompleteBarcode = null;
            //LoadPlateProduct4CompleteBarcode = null;
            //LoadPlateProduct5CompleteBarcode = null;
            //LoadPlateProduct6CompleteBarcode = null;
            //LoadPlateProduct7CompleteBarcode = null;
            //LoadPlateProduct8CompleteBarcode = null;
            //LoadPlateProduct9CompleteBarcode = null;
            //LoadPlateProduct10CompleteBarcode = null;
            //LoadPlateProduct11CompleteBarcode = null;
            //LoadPlateProduct12CompleteBarcode = null;
            //LoadPlateProduct13CompleteBarcode = null;
            //LoadPlateProduct14CompleteBarcode = null;
            //LoadPlateProduct15CompleteBarcode = null;
            //LoadPlateProduct16CompleteBarcode = null;
            BarcodeList.Clear();
        }
        #endregion
        ...
        public ushort LoadPlateProduct5CompleteState; // 完成信号,server读,client写 // 400126
        public ushort LoadPlateProduct6CompleteState; // 完成信号,server读,client写 // 400127
        public ushort CompleteSignal; // 完成信号,server读,client写 // 400126
        public string LoadPlateCompleteProductNo = string.Empty; // 完成信号,server读,client写 // 400127~40136
        ...
        public string LoadPlateProduct5CompleteBarcode = string.Empty;
        public string LoadPlateProduct6CompleteBarcode = string.Empty;
        public string LoadPlateProduct7CompleteBarcode = string.Empty;
        public string LoadPlateProduct8CompleteBarcode = string.Empty;

        public string LoadPlateProduct9CompleteBarcode = string.Empty; // 完成信号,server读,client写 // 400137~40161
        public string LoadPlateProduct10CompleteBarcode = string.Empty; // 完成信号,server读,client写 // 400162~40186
        public string LoadPlateProduct11CompleteBarcode = string.Empty; // 完成信号,server读,client写 // 400187~40211
        public string LoadPlateProduct12CompleteBarcode = string.Empty; // 完成信号,server读,client写 // 400212~40236
        public string LoadPlateProduct13CompleteBarcode = string.Empty;
        public string LoadPlateProduct14CompleteBarcode = string.Empty;
        public string LoadPlateProduct15CompleteBarcode = string.Empty;
        public string LoadPlateProduct16CompleteBarcode = string.Empty;



        public List<string> GetProduct1BarcodeList = new List<string>();
        public List<string> GetProduct2BarcodeList = new List<string>();
        public List<string> GetProduct3BarcodeList = new List<string>();
        public List<string> GetProduct4BarcodeList = new List<string>();
        public List<string> GetProduct5BarcodeList = new List<string>();
        public List<string> GetProduct6BarcodeList = new List<string>();
        public List<string> GetProduct7BarcodeList = new List<string>();
        public List<string> GetProduct8BarcodeList = new List<string>();
        public List<string> GetProduct9BarcodeList = new List<string>();
        public List<string> GetProduct10BarcodeList = new List<string>();
        public List<string> GetProduct11BarcodeList = new List<string>();
        public List<string> GetProduct12BarcodeList = new List<string>();
        public List<string> GetProduct13BarcodeList = new List<string>();
        public List<string> GetProduct14BarcodeList = new List<string>();
        public List<string> GetProduct15BarcodeList = new List<string>();
        public List<string> GetProduct16BarcodeList = new List<string>();



        public string LoadPlateProduct1CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400137~40161
        public string LoadPlateProduct2CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400162~40186
        public string LoadPlateProduct3CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400187~40211
        public string LoadPlateProduct4CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400212~40236
        public string LoadPlateProduct5CompleteBarcodeA = string.Empty;
        public string LoadPlateProduct6CompleteBarcodeA = string.Empty;
        public string LoadPlateProduct7CompleteBarcodeA = string.Empty;
        public string LoadPlateProduct8CompleteBarcodeA = string.Empty;
        public string LoadPlateProduct9CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400137~40161
        public string LoadPlateProduct10CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400162~40186
        public string LoadPlateProduct11CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400187~40211
        public string LoadPlateProduct12CompleteBarcodeA = string.Empty; // 完成信号,server读,client写 // 400212~40236
        public string LoadPlateProduct13CompleteBarcodeA = string.Empty;
        public string LoadPlateProduct14CompleteBarcodeA = string.Empty;
        public string LoadPlateProduct15CompleteBarcodeA = string.Empty;
        public string LoadPlateProduct16CompleteBarcodeA = string.Empty;



        public string LoadPlateProduct1state = "0";
        public string LoadPlateProduct2state = "0";
        public string LoadPlateProduct3state = "0";
        public string LoadPlateProduct4state = "0";
        public string LoadPlateProduct5state = "0";
        public string LoadPlateProduct6state = "0";
        public string LoadPlateProduct7state = "0";
        public string LoadPlateProduct8state = "0";
        ...
        public ushort LoadPlateProduct5State; // 载盘产品3状态,server写,client读 // 40005
        public ushort LoadPlateProduct6State; // 载盘产品4状态,server写,client读 // 40006
        public ushort StartSignal; // 启动信号,server写,client读  // 40005
        public string LoadPlateProductNo = string.Empty; // 载盘产品号,server写,client读  // 40006~40015
        ...
        public string LoadPlateProduct5Barcode = string.Empty; // 载盘产品3二维码,server写,client读 // 40066~40090
        public string LoadPlateProduct6Barcode = string.Empty; // 载盘产品4二维码,server写,client读 // 40091~40115
        ...
        public bool zaipanOK;
        public bool zhongjianOK;
        public bool warn;
        public double NGtimes = 0;
    }
}
