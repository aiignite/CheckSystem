...
{
    [Description("CAN-Product,DC1E后灯-海外版")]
    public sealed class Dc1ERearLampEu : ControllerBase
    {
        public CanBus Can;

        private VectorDbcEmulator VectorEmulator { get; set; }

        public Dc1ERearLampEu(string name)
            : base(name)
        {
            SysConfig(Directory.GetCurrentDirectory() + @"\ControllerConfig\ZSDB122200_DC1E_EU_BodyExposedCAN_220701.dbc");
        }
