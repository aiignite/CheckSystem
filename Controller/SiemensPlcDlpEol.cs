...
{
    public sealed class SiemensPlcDlpEol : ControllerBase
    {
        ...
        [Description("R/W,Hr400135")]
        public ushort Hr40135;
        [Description("R/W,Hr400136")]
        public ushort Hr40136;
        [Description("R/W,Hr400137")]
        public ushort Hr40137;
        [Description("R/W,Hr400138")]
        ...
        public SiemensPlcDlpEol(string name) :
            base(name) { }
        ...
        private void Read()
        {
            while (true)
            {
                ...
                while (true)
                {
                    var r1 = _sienmensModbusTcpNet.ReadDiscrete("3000", (ushort)r1Content.Length); // I10001
                    if (!r1.IsSuccess)
                        continue;
        ...
        private void Write()
        {
            ...
            while (true)
            {
                var w1 = _sienmensModbusTcpNet.WriteCoil("2000", bools); // O00001
