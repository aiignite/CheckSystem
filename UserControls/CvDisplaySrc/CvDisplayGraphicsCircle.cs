...
namespace UserControls.CvDisplaySrc
{
    class CvDisplayGraphicsCircle : CvDisplayGraphicsDot
    {
        ...
        public override bool IsMouseIn(PointF pos)
        {
            ...
            double distance = Calculate.Distance(DisplayOrigin, new Point2d(pos.X, pos.Y));
        ...
        public override void OnMouseMove(MouseEventArgs e)
        {
            ...
            else if(Selected && IsLeftMouseDown && _SelectedType == SelectedType.Edge)
            {
                ...
                double moveRadius =Calculate.Hypotenuse(moveX * pixelSize.Width, moveY * pixelSize.Height);

                double distanceNew= Calculate.Distance(DisplayOrigin, new Point2d(e.X, e.Y)),
                    distancOld = Calculate.Distance(DisplayOrigin, new Point2d(MouseDownPos.X, MouseDownPos.Y));
