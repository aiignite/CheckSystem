...
using HZH_Controls.UIEditor;

namespace HZH_Controls.Controls.Btn
{
    /// <summary>
    /// Class UCBtnImg.
    /// Implements the <see cref="UCBtnExt" />
    /// </summary>
    /// <seealso cref="UCBtnExt" />
    public partial class UCBtnImg : UCBtnExt
    {
        ...
        /// </summary>
        private object _imageFontIcons;
        /// <summary>
        ...
        {
            get { return _imageFontIcons; }
            set
            {
                if (value != null && !(value is Image)) 
                    return;
                _imageFontIcons = value;
                if (value != null)
                    Image = (Image)value;
            }
        }
