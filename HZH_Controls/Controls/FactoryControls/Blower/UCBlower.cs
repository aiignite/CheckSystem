...
namespace HZH_Controls.Controls.FactoryControls.Blower
{
    /// <summary>
    /// Class UCBlower.
    ...
    public class UCBlower : UserControl
    {
        ...
        {
            if (turnAround == TurnAround.Clockwise)
            {
                jiaodu += 15;
                if (jiaodu == 45)
                    jiaodu = 0;
            }
            else if (turnAround == TurnAround.Counterclockwise)
            {
                jiaodu -= 15;
                if (jiaodu == -45)
                    jiaodu = 0;
