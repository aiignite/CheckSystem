...
using HZH_Controls.Controls.DataGridView;

namespace HZH_Controls.Controls.Transfer
{
    partial class UCTransfer
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dgvRight = new UCDataGridView();
            this.btnLeft = new UCBtnImg();
            this.btnRight = new UCBtnImg();
            this.ucControlBase1 = new HZH_Controls.Controls.UCControlBase();
            this.dgvLeft = new UCDataGridView();
            ...
            this.dgvRight.RowType = typeof(UCDataGridViewRow);
            ...
            this.dgvLeft.RowType = typeof(UCDataGridViewRow);
