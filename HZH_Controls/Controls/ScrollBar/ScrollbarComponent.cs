...
namespace HZH_Controls.Controls.ScrollBar
{
    ...
    public class ScrollbarComponent : Component, IExtenderProvider
    {
        ...
        public bool CanExtend(object extendee)
        {
            ...
            //    return true;
            //}
            else if (extendee is System.Windows.Forms.DataGridView)
            {
                return true;
            }
            return false;
        ...
        public void SetUserCustomScrollbar(Control control, bool blnUserCustomScrollbar)
        {
            ...
            {
                System.Windows.Forms.DataGridView dgv = (System.Windows.Forms.DataGridView)control;
        ...
        void control_SizeChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var dgv = (System.Windows.Forms.DataGridView)control;
        ...
        void barV_Scroll(object sender, EventArgs e)
        {
            ...
            if (m_lstVCache.ContainsValue(bar))
            {
                ...
                {
                    var dgv = (System.Windows.Forms.DataGridView)c;
                    if(bar.Value>0)
