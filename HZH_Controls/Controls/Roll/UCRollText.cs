...
namespace HZH_Controls.Controls.Roll
{
    ...
    public class UCRollText : UserControl
    {
        ...
        void m_timer_Tick(object sender, EventArgs e)
        {
            ...
            if (_RollStyle == RollStyle.BackAndForth && rectText.Width >= this.Width)
            {
                return;
            }
            rectText.X = rectText.X + _moveStep * m_intdirection;
            if (_RollStyle == RollStyle.BackAndForth)
            {
                if (rectText.X <= 0)
                {
                    m_intdirection = 1;
            ...
            else if (_RollStyle == RollStyle.LeftToRight)
            {
        ...
        {
            if (_RollStyle == RollStyle.LeftToRight)
            {
                m_intdirection = 1;
                if (rectText != Rectangle.Empty)
                {
            ...
            else if (_RollStyle == RollStyle.RightToLeft)
            {
                m_intdirection = -1;
                if (rectText != Rectangle.Empty)
                {
