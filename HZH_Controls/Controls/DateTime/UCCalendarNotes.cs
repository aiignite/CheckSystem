    ...
    public partial class UCCalendarNotes : UserControl
    {
        ...
        void lblDay_Paint(object sender, PaintEventArgs e)
        {
            try
            {
                ...
                string data = System.DateTime.Parse(m_dt.Year + "-" + lbl.Tag).ToString("yyyy-MM-dd");
        ...
        void lblYearItem_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            CurrentTime = System.DateTime.Parse(((Label)sender).Tag + "-" + m_dt.Month + "-" + m_dt.Day);
        }

        void lblMonthItem_MouseClick(object sender, MouseEventArgs e)
        {
            panSelectMonth.Visible = false;
            CurrentTime = System.DateTime.Parse(m_dt.Year + "-" + ((Label)sender).Tag + "-" + m_dt.Day);
        }
        ...
        void lblDay_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                CurrentTime = System.DateTime.Parse(m_dt.Year + "-" + lbl.Tag);
            }
        ...
        private void lblMouth_TextChanged(object sender, EventArgs e)
        {
            ...
            CurrentTime = System.DateTime.Parse(m_dt.Year + "-" + mouth + "-" + m_dt.Day);
            ...
            System.DateTime dt1 = System.DateTime.Parse(m_dt.Year + "-" + m_dt.Month + "-01");
        ...
        private void ucCalendarNotes_Week1_AddClick(System.DateTime beginTime)
        {
            if (AddClick != null)
                AddClick(beginTime);
        }
