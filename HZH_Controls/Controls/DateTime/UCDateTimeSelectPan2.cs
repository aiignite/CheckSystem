...
namespace HZH_Controls.Controls.DateTime
{
    ...
    public partial class UCDateTimeSelectPan2 : UserControl
    {
        ...
        /// The m dt
        /// </summary>
        System.DateTime m_dt = System.DateTime.Now;
        ...
        void lblSecondItem_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            CurrentTime = System.DateTime.Parse(m_dt.ToString("yyyy-MM-dd HH:mm") + ":" + ((Label)sender).Text);
        }

        void lblMinuteItem_MouseClick(object sender, MouseEventArgs e)
        {
            panSelectMinute.Visible = false;
            CurrentTime = System.DateTime.Parse(m_dt.ToString("yyyy-MM-dd") + " " + m_dt.Hour + ":" + ((Label)sender).Text + ":" + m_dt.Second);
        }

        void lblHourItem_MouseClick(object sender, MouseEventArgs e)
        {
            panSelectHour.Visible = false;
            CurrentTime = System.DateTime.Parse(m_dt.ToString("yyyy-MM-dd") + " " + ((Label)sender).Text + ":" + m_dt.ToString("mm:ss"));
        }

        void lblYearItem_MouseClick(object sender, MouseEventArgs e)
        {
            panSelectYear.Visible = false;
            CurrentTime = System.DateTime.Parse(((Label)sender).Tag + "-" + m_dt.Month + "-" + m_dt.Day + " " + m_dt.ToString("HH:mm:ss"));
        }

        void lblMonthItem_MouseClick(object sender, MouseEventArgs e)
        {
            panSelectMonth.Visible = false;
            CurrentTime = System.DateTime.Parse(m_dt.Year + "-" + ((Label)sender).Tag + "-" + m_dt.Day + " " + m_dt.ToString("HH:mm:ss"));
        }
        ...
        void lblDay_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                CurrentTime = System.DateTime.Parse(m_dt.Year + "-" + lbl.Tag + " " + m_dt.ToString("HH:mm:ss"));
            }
        }
        ...
        private void lblMouth_TextChanged(object sender, EventArgs e)
        {
            ...
            CurrentTime = System.DateTime.Parse(m_dt.Year + "-" + mouth + "-" + m_dt.Day + " " + m_dt.ToString("HH:mm:ss"));
            int intDayCount = System.DateTime.DaysInMonth(m_dt.Year, m_dt.Month);
            System.DateTime dtlastMonth = m_dt.AddMonths(-1);
            int intlasyMonthDayCount = System.DateTime.DaysInMonth(dtlastMonth.Year, dtlastMonth.Month);
            System.DateTime dt1 = System.DateTime.Parse(m_dt.Year + "-" + m_dt.Month + "-01 00:00:01");
            ...
            if (lst.Count < 42)
            {
                System.DateTime dtNextMonth = m_dt.AddMonths(1);
        ...
        {
            CurrentTime = System.DateTime.Parse(lblYear.Tag + "-" + m_dt.ToString("MM-dd HH:mm:ss"));
