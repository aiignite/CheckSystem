...
using HZH_Controls.Controls.ComboBox;
...
namespace HZH_Controls.Controls.Verification
{
    ...
    public class VerificationComponent : Component, IExtenderProvider
    {
        ...
        {
            if (extendee is TextBoxBase || extendee is UCTextBoxEx || extendee is System.Windows.Forms.ComboBox || extendee is UCCombox)
            {
                return true;
            }
            return false;
        ...
        public bool Verification(Control c)
        {
            ...
            if (m_controlCache.ContainsKey(c))
            {
                ...
                {
                    var cbo = (c as System.Windows.Forms.ComboBox);
