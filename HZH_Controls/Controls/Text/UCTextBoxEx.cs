...
using HZH_Controls.Controls.KeyBord;
using HZH_Controls.Helpers;

namespace HZH_Controls.Controls.Text
{
    /// <summary>
    /// Class UCTextBoxEx.
    ...
    public partial class UCTextBoxEx : UCControlBase
    {
        ...
        /// The m hand p win
        /// </summary>
        System.Diagnostics.Process m_HandPWin = null;
        /// <summary>
        ...
        void m_frmAnchor_VisibleChanged(object sender, EventArgs e)
        {
            if (m_frmAnchor.Visible)
            {
                var lstP = System.Diagnostics.Process.GetProcessesByName("handinput");
                if (lstP.Length > 0)
                {
