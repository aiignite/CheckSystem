...
namespace HZH_Controls.Controls.DataGridView
{
    /// <summary>
    ...
    public partial class UCDataGridView : UserControl
    {
            ...
            set
            {
                if (m_isShowHead != value)
                {
                    ...
                    if (value)
                    {
                        ...
                        panRow.Height = panRow.Height - panHead.Height;
                    }
                    else
                    {
        ...
        public int ShowCount
        {
            get
            {
                return panRow.Height / (m_rowHeight);
            }
        }
        ...
        {
            if (e.ScrollOrientation == ScrollOrientation.HorizontalScroll && panRow.Controls.Count > 0)
            {
                Console.WriteLine(panRow.HorizontalScroll.Value);
                Console.WriteLine(panRow.Controls[0].Location.X);
                panHead.Location = new Point(panRow.HorizontalScroll.Value * -1, 0);
            }
        }
    }
}
