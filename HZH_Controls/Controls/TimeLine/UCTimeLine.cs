...
using HZH_Controls.Colors;
using HZH_Controls.Helpers;

namespace HZH_Controls.Controls.TimeLine
{
    /// <summary>
    /// Class UCTimeLine.
        ...
        public UCTimeLine()
        {
            ...
            if (ControlHelper.IsDesignMode())
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    {
                        Title = System.DateTime.Now.AddMonths(-1 * (3 - i)).ToString("yyyy年MM月"),
                        Details = System.DateTime.Now.AddMonths(-1 * (3 - i)).ToString("yyyy年MM月") + "发生了一件大事，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，咔嚓一声打了一个炸雷，然后王二麻子他爹王咔嚓出生了。"
                    };
                }
                ReloadItems();
            }
