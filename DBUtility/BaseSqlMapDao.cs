...
namespace DBUtility
{
    ...
    public class BaseSqlMapDao 
    {
        ...
        public BaseSqlMapDao()
        {
            ...
            var assembly = Assembly.Load("IBatisNetDemo");
            var stream = assembly.GetManifestResourceStream("IBatisNetDemo.sqlmap.config");

            var builder = new DomSqlMapBuilder();            
            _sqlMap = builder.Configure(stream);
        }
        ...
        protected IList<T> ExecuteQueryForList<T>(string statementName, object parameterObject)
        {
            try
            {
                return _sqlMap.QueryForList<T>(statementName, parameterObject);
            }
            catch (Exception e)
            {
        ...
        protected IList<T> ExecuteQueryForList<T>(string statementName, object parameterObject, int skipResults, int maxResults)
        {
            try
            {
                return _sqlMap.QueryForList<T>(statementName, parameterObject, skipResults, maxResults);
            }
            catch (Exception e)
            {
                throw new DataMapperException("Error executing query '" + statementName + "' for list.  Cause: " + e.Message, e);
        ...
        protected IPaginatedList ExecuteQueryForPaginatedList(string statementName, object parameterObject, int pageSize)
        {
            try
            {
                return _sqlMap.QueryForPaginatedList(statementName, parameterObject, pageSize);
            }
            catch (Exception e)
            {
        ...
        protected T ExecuteQueryForObject<T>(string statementName, object parameterObject)
        {
            try
            {
                return _sqlMap.QueryForObject<T>(statementName, parameterObject);
            }
            catch (Exception e)
            {
        ...
        protected void ExecuteInsert(string statementName, object parameterObject)
        {
            try
            {
                _sqlMap.Insert(statementName, parameterObject);
            }
            catch (Exception e)
            {
        ...
        protected void ExecuteUpdate(string statementName, object parameterObject)
        {
            try
            {
                _sqlMap.Update(statementName, parameterObject);
            }
            catch (Exception e)
            {
        ...
        protected void ExecuteDelete(string statementName, object parameterObject)
        {
            try
            {
                _sqlMap.Delete(statementName, parameterObject);
            }
            catch (Exception e)
            {
