...
{
    public partial class FrmAlcmLedParaSet : Form
    {
        ...
        public FrmAlcmLedParaSet(string xmlFilePath, string funcName)
        {
            InitializeComponent();
