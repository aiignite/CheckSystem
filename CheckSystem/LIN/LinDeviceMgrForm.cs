    ...
    public partial class LinDeviceMgrForm : UIForm
    {
        ...
        private void comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ucmbDevicesList.comboBox.Text == typeof(ControllerWithGateway).Name)
                ...
                foreach (var f in typeof(SyRenesasMcuControllerMaster).GetFields().Where(f => f.FieldType == typeof(LinBus)))
                    ucmbLINList.comboBox.Items.Add(f.Name);
