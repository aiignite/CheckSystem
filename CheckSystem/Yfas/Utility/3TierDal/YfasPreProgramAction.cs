...
namespace CheckSystem.Yfas.Utility._3TierDal
{
    ...
    public partial class YfasPreProgramAction
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from YfasPreProgramAction");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(_3TierModel.YfasPreProgramAction model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into YfasPreProgramAction(");
            strSql.Append("Name,Row,CarModel,ActionType,IsDelete)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(_3TierModel.YfasPreProgramAction model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update YfasPreProgramAction set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from YfasPreProgramAction ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public _3TierModel.YfasPreProgramAction GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,Name,Row,CarModel,ActionType,IsDelete from YfasPreProgramAction ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
            ...
            _3TierModel.YfasPreProgramAction model = new _3TierModel.YfasPreProgramAction();
        ...
        /// 得到一个对象实体
        /// </summary>
        public _3TierModel.YfasPreProgramAction DataRowToModel(DataRow row)
        {
            _3TierModel.YfasPreProgramAction model = new _3TierModel.YfasPreProgramAction();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,Name,Row,CarModel,ActionType,IsDelete ");
            strSql.Append(" FROM YfasPreProgramAction ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,Name,Row,CarModel,ActionType,IsDelete ");
            strSql.Append(" FROM YfasPreProgramAction ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from YfasPreProgramAction T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "YfasPreProgramAction";
