...
namespace CheckSystem.Yfas.Utility._3TierBll
{
    ...
    {
        private readonly _3TierDal.YfasProductParas dal = new _3TierDal.YfasProductParas();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public _3TierModel.YfasProductParas GetModelByCache(int id)
        {

            string CacheKey = "YfasProductParasModel-" + id;
            ...
            return (_3TierModel.YfasProductParas)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<_3TierModel.YfasProductParas> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<_3TierModel.YfasProductParas> DataTableToList(DataTable dt)
        {
            List<_3TierModel.YfasProductParas> modelList = new List<_3TierModel.YfasProductParas>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                _3TierModel.YfasProductParas model;
