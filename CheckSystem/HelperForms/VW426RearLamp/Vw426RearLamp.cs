...
namespace CheckSystem.HelperForms.VW426RearLamp
{
    public sealed partial class Vw426RearLamp : UIForm
    {
        ...
        private readonly string SBBR_Schlusslicht_Signatur = "SBBR_Schlusslicht_Signatur";

        public Vw426RearLamp(bool isToomoss)
        {
            InitializeComponent();
            ...
            else
            {
                ...
                (LinController as ToomossUsb2XxxCanLin).CheckType = 1;
            ...
            _matrixValDefinitions.Add(SBBR_Schlusslicht_Signatur, new MatrixValDefinition(60, 4, 0));
        ...
        {
            _matrixValDefinitions[SBBR_Schlusslicht_Signatur].Value = (byte)cmbChLhAnimation.SelectedIndex;
        }
        ...
        private void uiSwitchChLhInvoke_ValueChanged(object sender, bool value)
        {
            if (value)
            {
                ...
                if (rdBtnCh.Checked && !rdBtnLh.Checked) // CHO动画，转向灯闪烁两次
                {
                    ...
                    _matrixValDefinitions[SBBR_Schlusslicht_Signatur].Value = 0x00; // 动画模式为模式0（   默认模式）
            ...
            {
                _matrixValDefinitions[SBBR_Schlusslicht_Signatur].Value = 0; // 动画模式为模式0（默认模式）
