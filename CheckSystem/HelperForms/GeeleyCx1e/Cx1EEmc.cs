...
namespace CheckSystem.HelperForms.GeeleyCx1e
{
    public sealed class Cx1EEmc : ControllerBase
    {
        ...
        private readonly CanCommunicationMatrix.MotorolaMatrix _wakeup_0X53F =
        ...
        ///     门Ajar开关状态,0x05,46,2
        /// </summary>
        [EmcAttribute(EmcType.State, "门Ajar开关状")]
        ...
        {
            if (AppCan != null && AppCan.Name == name)
            {
                ...
                else if (data.CanId == 0x05)
                {
                    try
                    {
                        ...
                        if (matrix0X05.GetMatrixData(22, 2) == 0)
                            ...
                            DoorDrvrOpenLowReqOutdSwt1 = "Off_3";
                    }
                    catch (Exception)
                    {
                ...
                .OnEntry(async () =>
                {
                    ...
                    lock (Lock)
                    {
                        AppCan.SendStandardCanData(ReqCanId,
                            new byte[] { 0x02, 0x10, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00 });
                        Thread.Sleep(50);
                        AppCan.SendStandardCanData(ReqCanId,
                            new byte[] { 0x02, 0x27, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00 });
                        Thread.Sleep(50);
                        AppCan.SendStandardCanData(ReqCanId,
                            new byte[] { 0x05, 0x27, 0x06, 0x11, 0x22, 0x33, 0x00, 0x00 });
                        Thread.Sleep(50);
                    }

                    Machine.Fire(EmcTrigger.StartIoControl);
                })
        ...
        {
            _wakeup_0X53F.MatrixData = new byte[] { 0x3F, 0x40, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };

            _cemBodyFr09_0X41.UpdateData(new MatrixValDefinition(50, 1, 1));
            _cemBodyFr09_0X41.UpdateData(new MatrixValDefinition(59, 1, 1));
            ...
            _cemBodyFr103_0X5B.UpdateData(new MatrixValDefinition(41, 1, 1));
            ...
            _cemBodyFr78_0X00B4.UpdateData(new MatrixValDefinition(3, 1, 1));
            _cemBodyFr78_0X00B4.UpdateData(new MatrixValDefinition(26, 1, 1));
            _cemBodyFr78_0X00B4.UpdateData(new MatrixValDefinition(49, 1, 1));
            _cemBodyFr78_0X00B4.UpdateData(new MatrixValDefinition(52, 1, 1));
            _cemBodyFr78_0X00B4.UpdateData(new MatrixValDefinition(55, 1, 1));
            _cemBodyFr78_0X00B4.UpdateData(new MatrixValDefinition(56, 1, 1));

            //_cemBodyFr108_0X00F3.UpdateData(new MatrixValDefinition(30, 1, 1));
            //_cemBodyFr108_0X00F3.UpdateData(new MatrixValDefinition(51, 1, 1));
            _cemBodyFr108_0X00F3.UpdateData(new MatrixValDefinition(52, 1, 1));

            _cemBodyFr179_0X346.UpdateData(new MatrixValDefinition(9, 1, 1));
            _cemBodyFr179_0X346.UpdateData(new MatrixValDefinition(43, 1, 1));
            _cemBodyFr179_0X346.UpdateData(new MatrixValDefinition(51, 1, 1));
            _cemBodyFr179_0X346.UpdateData(new MatrixValDefinition(56, 1, 1));
            ...
            _timers.Add(new MyTimer { Period = 15, Timer = new Timer(DoMatrixWork, _cemBodyFr09_0X41, Timeout.Infinite, 15) });
            _timers.Add(new MyTimer { Period = 15, Timer = new Timer(DoMatrixWork, _cemBodyFr103_0X5B, Timeout.Infinite, 15) });
            _timers.Add(new MyTimer { Period = 20, Timer = new Timer(DoMatrixWork, _cemBodyFr03_0X76, Timeout.Infinite, 20) });

            _timers.Add(new MyTimer { Period = 40, Timer = new Timer(DoMatrixWork, _cemBodyFr11_0X00E0, Timeout.Infinite, 40) });
            _timers.Add(new MyTimer { Period = 40, Timer = new Timer(DoMatrixWork, _cemBodyFr124_0X194, Timeout.Infinite, 40) });
            _timers.Add(new MyTimer { Period = 50, Timer = new Timer(DoMatrixWork, _cemBodyFr78_0X00B4, Timeout.Infinite, 50) });
            _timers.Add(new MyTimer { Period = 60, Timer = new Timer(DoMatrixWork, _cemBodyFr108_0X00F3, Timeout.Infinite, 60) });
            _timers.Add(new MyTimer { Period = 60, Timer = new Timer(DoMatrixWork, _cemBodyFr179_0X346, Timeout.Infinite, 60) });
            _timers.Add(new MyTimer { Period = 65, Timer = new Timer(DoMatrixWork, _cemBodyFr12_0X00F0, Timeout.Infinite, 65) });
            _timers.Add(new MyTimer { Period = 390, Timer = new Timer(DoMatrixWork, _cemBodyFr19_0X210, Timeout.Infinite, 390) });

            _timers.Add(new MyTimer { Period = 500, Timer = new Timer(DoMatrixWork, _wakeup_0X53F, Timeout.Infinite, 500) });

            _timers.Add(new MyTimer
            {
                Period = 100,
                Timer = new Timer(Do22Work, null, Timeout.Infinite, 100)
            });
            ...
            foreach (var t in List2FBytes)
                ...
                {
                    Period = 100,
                    Timer = new Timer(Do2FWork, t.Key, Timeout.Infinite, 100)
                });
        }
        ...
        private void DoMatrixWork(object state)
        {
        ...
        private void Do22Work(object state)
        {
            if (AppCan == null)
                return;
            lock (Lock)
        ...
        private void Do2FWork(object state)
        {
            if (AppCan == null)
                return;
